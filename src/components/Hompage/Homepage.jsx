            ...
            <div className="homepage__container">
                <div className="left__container">
                    ...
                    <motion.div
                        initial={{opacity: 0, x: -50}}
                        animate={{opacity: 1, x: 0}}
                        transition={{ duration: 1, delay: 0.6, type: 'spring', ease: 'easeOut' }}
                    >
                        <div className="left__buttons">
                            <Link to="/find" className="find__btn btn">Tarifi Bul</Link>
                            <Link to={`/random/${randomMeal.idMeal}`} className="random__btn btn">
                                <i className='bx bxs-dice-5 bx-tada bx-rotate-90'></i>Şaşırt Beni!
                            </Link>
                        </div>
                    </motion.div>
                </div>
